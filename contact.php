...
if(isset($_POST["submit"])){$ourmail = 'info@marketingojo.com';
$email=$_POST['email'];
$name = $_POST['name'];
$campany=$_POST['company'];
$phone=$_POST['contact'];
$date=date("Y-m-d");
$msg ="Services: - ".implode('<br>',$_POST['service'])."<br><br>"."Message: - ".$_POST['message']."<br><br>Contact: ".$phone."<br>Company:".$campany;
