              ...
              <table id="example1" class="table table-bordered table-responsive">
                ...
                <tbody>
                  <?php
                    ...
                    try{
                      $now = date('Y-m-d');
                      $stmt = $conn->prepare("SELECT * FROM ideas $where");
                      $stmt->execute();
                      foreach($stmt as $row){
                        echo "
                          <tr>
                         ...
                         <td>".$row['Added_on']."</td>
                            <td>";
                              if($row['Status']==1){
                                  echo "<button class='btn btn-sm btn-flat btn-info'><a style='color: white;' href='?table=ideas&type=status&operation=deactive&id=".$row['ID']."' >Active</a></button>";

              
                }else{
                   echo "<button class='btn btn-danger btn-sm  btn-flat'><a style='color: white;' href='?table=ideas&type=status&operation=active&id=".$row['ID']."'>Deactive</a></button>";
                }echo "
