              ...
              <table id="example1" class="table table-bordered table-responsive">
                ...
                <tbody>
                  <?php
                    ...
                    try{
                      $now = date('Y-m-d');
                      $stmt = $conn->prepare("SELECT * FROM careers $where");
                      $stmt->execute();
                      foreach($stmt as $row){
                        echo "
                          <tr>
                          ...
                          <td><a href='#description' data-toggle='modal' class='btn btn-info btn-sm btn-flat desc' data-id='".$row['ID']."'><i class='fa fa-search'></i> View</a></td>
                                <td><a href='../download/".$row['Resume']."'download><i class='fa fa-download' aria-hidden='true'></i></a></td>
                         <td>".$row['Added_on']."</td>
                            <td>
...
$(function(){
  ...
  $('#select_category').change(function(){
    ...
    if(val == 0){
      ...
      window.location = 'career.php?date_range='+val;
    }
  });
