...
if(isset($_GET['type']) && $_GET['type']!=''){
   ...
   if($type=='status'){
      ...
      $update_status_sql="update folder set status='$status' where id='$id'";
      mysqli_query($con,$update_status_sql);
   }
   
   if($type=='delete'){
      $id=get_safe_value($con,$_GET['id']);
      $delete_sql="delete from folder where id='$id'";
      mysqli_query($con,$delete_sql);
   }
}

$sql="select * from folder order by Name asc";
        ...
        <div class="col-xl-12">
          <div class="card">
            <div class="card-body">
               ...
               <h4 class="box-link"><a href="manage_folder.php">Add Folder</a> </h4>
            </div>
            <div class="card-body--">
                 ...
                 <table class="table ">
                   ...
                   <tbody>
                     ...
                     <tr>
                        ...
                        echo "<span class='badge badge-edit'><a href='manage_folder.php?id=".$row['id']."'>Edit</a></span>&nbsp;";
